...
const ProjectProgress = () => {
    return (
        <div className="xl:col-span-4 xl:row-span-2 bg-white rounded-[24px] sm:rounded-[32px] border border-gray-200 p-5 sm:p-6 flex flex-col items-center">
            <h3 className="text-base font-semibold text-gray-800 w-full mb-4">
                Project Progress
            </h3>
            ...
            <div className="flex items-center justify-between w-full mt-6 px-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="w-3 h-3 rounded-full bg-gray-100 overflow-hidden relative">
                        <div className="absolute inset-0 [background-image:repeating-linear-gradient(45deg,transparent,transparent_1px,#9ca3af_1px,#9ca3af_2px)]"></div>
                    </div>
